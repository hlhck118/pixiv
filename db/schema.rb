...
ActiveRecord::Schema.define(version: 20150201123258) do
  ...
  add_index "illustrations", ["privacy_level_id"], name: "index_illustrations_on_privacy_level_id", using: :btree
  add_index "illustrations", ["restriction_id"], name: "index_illustrations_on_restriction_id", using: :btree
